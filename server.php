...
if (isset($_POST['reg_user'])) {
	...
	if (!preg_match($format, $username)) {
	    array_push($errors, "<font color='#a94442'>Invalid ID format. ID should have 12 numbers only.</font>");
	}
	...
	else if(strlen($phone)!=10) { array_push($errors, "Phone number must contain 10 digits.");}
